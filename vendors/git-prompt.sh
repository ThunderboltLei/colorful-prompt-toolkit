...
__git_ps1 ()
{
	...
	# echo -e "===== h: $h, w: $w, i: $i, s: $s, u: $u, p: $p"
	# echo -e "===== gitstring - c: $c, b: $b, f: ${f:+$z$f}, sparse: ${sparse}, r: $r, upstream: ${upstream}, conflict: ${conflict}"
	# echo -e "===== 1. printf_format: $printf_format"
	...
	# printf "===== 2. printf_format: $printf_format - $gitstring"
